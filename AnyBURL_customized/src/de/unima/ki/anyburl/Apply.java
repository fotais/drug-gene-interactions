...
public class Apply {
	...
	*/
	...
	public static int TNs=0;
	public static int FPs=0;
	public static int FNs=0;
	...
	public static void main(String[] args) throws IOException {
		...
		if (Settings.PREDICTION_TYPE.equals("aRx")) {			
			...
			for (String value : values) {
				...
				//FOT
				TripleSet testSet = new TripleSet(Settings.PATH_TEST, "test");
		...
		float prec = (float)TPs/((float)(TPs+FPs));
		float rec= (float)TPs/((float)(TPs+FNs));
